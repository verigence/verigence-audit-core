...
from audit_core.uc03_document_capture_v2 import _authorize_booking
...
def test_v2_capture_authorization_does_not_take_stage_write_lock(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "audit_core.uc03_document_capture_v2._capture_phase_state",
        fake_capture_phase_state,
    )

    result = _authorize_booking(
        object(),
        tenant_id="tenant-1",
