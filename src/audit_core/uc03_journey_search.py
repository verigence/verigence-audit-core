    ...
    return connection.execute(
        text(
            ...
            SELECT
                ...
                bs.capture_completed_at_utc AS "bookingCaptureCompletedAtUtc",
                COALESCE(bs.pc_verification_status, 'PENDING') AS "bookingPcVerificationStatus",
                ...
                ds.capture_completed_at_utc AS "deliveryCaptureCompletedAtUtc",
                COALESCE(ds.pc_verification_status, 'PENDING') AS "deliveryPcVerificationStatus",
    ...
    findings = connection.execute(
        text(
            ...
            SELECT
                ...
                rule_key AS "ruleKey",
                finding_class AS "findingClass",
                owner_role_code AS "ownerRoleCode",
                sla_due_at_utc AS "slaDueAtUtc",
