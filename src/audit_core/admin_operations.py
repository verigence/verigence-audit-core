...
def administrative_operation_lock(
    ...
    *,
    ...
    lock_key = f"{operation_type}:{tenant_id}:{idempotency_key}"
    ...
    with engine.begin() as connection:
        ...
        existing = connection.execute(
            text(
                ...
                SELECT operation_id, operation_type, tenant_id, status, current_step,
                       semantic_request_hash, safe_request_summary,
                       security_receipt, audit_core_receipt
        ...
        row = connection.execute(
            text(
                ...
                RETURNING operation_id, operation_type, tenant_id, status, current_step,
                          semantic_request_hash, safe_request_summary,
                          security_receipt, audit_core_receipt
                """
            ),
