...
ATTRIBUTE_SPECS: tuple[AttributeSpec, ...] = (
    ...
    AttributeSpec(
        attribute_key="customer_date_of_birth",
        excel_field_no=None,
        label="Date of Birth",
        stages=("BOOKING", "DELIVERY"),
        field_keys=frozenset({"date_of_birth"}),
        source_priority=_ID,
    ),
    AttributeSpec(
        ...
        stages=("BOOKING", "DELIVERY"),
        field_keys=frozenset({"aadhaar_number"}),
        source_priority=("aadhaar",),
    ),
    AttributeSpec(
        attribute_key="customer_gender",
        excel_field_no=None,
        label="Gender",
        stages=("BOOKING", "DELIVERY"),
        field_keys=frozenset({"gender"}),
        source_priority=("aadhaar",),
    ),
    AttributeSpec(
        attribute_key="customer_address",
        excel_field_no=None,
        label="Customer Address",
        stages=("BOOKING", "DELIVERY"),
        field_keys=frozenset({"customer_address", "aadhaar_address"}),
        source_priority=("aadhaar", "booking_form", "booking_docket"),
    ),
    AttributeSpec(
    ...
    AttributeSpec(
        attribute_key="dealer_name",
        excel_field_no=None,
        label="Dealer Name",
        stages=("BOOKING",),
        field_keys=frozenset({"dealer_name"}),
        source_priority=_B,
    ),
    AttributeSpec(
        attribute_key="dealer_branch",
        excel_field_no=None,
        label="Dealer Branch",
        stages=("BOOKING",),
        field_keys=frozenset({"dealer_branch"}),
        source_priority=_B,
    ),
    AttributeSpec(
