...
Recommended automatic Flag category: `DOCUMENT_EXCEPTION` unless a more specific approved category is already defined for the field.
...
The Flag description should identify the field and the changed-from / changed-to values. Sensitive fields must still follow applicable masking/privacy rules.
